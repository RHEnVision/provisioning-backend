...
var (
	ContextReadError                 = errors.New("missing variable in context")
	ContextSecondInitializationError = errors.New("trying to initialize context twice, please avoid that")
)
