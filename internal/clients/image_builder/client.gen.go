...
const (
	...
	DistributionsRhel86 Distributions = "rhel-86"

	DistributionsRhel90 Distributions = "rhel-90"
)
...
type ServerInterface interface {
	...
	GetArchitectures(w http.ResponseWriter, r *http.Request, distribution string)
	// compose image
	// (POST /compose)
	ComposeImage(w http.ResponseWriter, r *http.Request)
	// get a collection of previous compose requests for the logged in user
	// (GET /composes)
	GetComposes(w http.ResponseWriter, r *http.Request, params GetComposesParams)
	// get status of an image compose
	// (GET /composes/{composeId})
	GetComposeStatus(w http.ResponseWriter, r *http.Request, composeId string)
	// get metadata of an image compose
	// (GET /composes/{composeId}/metadata)
	GetComposeMetadata(w http.ResponseWriter, r *http.Request, composeId string)
...
func (siw *ServerInterfaceWrapper) GetArchitectures(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetArchitectures(w, r, distribution)
	}
...
func (siw *ServerInterfaceWrapper) ComposeImage(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ComposeImage(w, r)
	}
...
// GetComposes operation middleware
func (siw *ServerInterfaceWrapper) GetComposes(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetComposes(w, r, params)
	}
...
func (siw *ServerInterfaceWrapper) GetComposeStatus(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetComposeStatus(w, r, composeId)
	}
...
// GetComposeMetadata operation middleware
func (siw *ServerInterfaceWrapper) GetComposeMetadata(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetComposeMetadata(w, r, composeId)
	}
...
func (siw *ServerInterfaceWrapper) GetDistributions(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetDistributions(w, r)
	}
...
func (siw *ServerInterfaceWrapper) GetPackages(w http.ResponseWriter, r *http.Request) {
	...
	if paramValue := r.URL.Query().Get("distribution"); paramValue != "" {

	} else {
		http.Error(w, "Query argument distribution is required, but not found", http.StatusBadRequest)
		return
	}

	err = runtime.BindQueryParameter("form", true, true, "distribution", r.URL.Query(), &params.Distribution)
	if err != nil {
		http.Error(w, fmt.Sprintf("Invalid format for parameter distribution: %s", err), http.StatusBadRequest)
		return
	}
	...
	if paramValue := r.URL.Query().Get("architecture"); paramValue != "" {

	} else {
		http.Error(w, "Query argument architecture is required, but not found", http.StatusBadRequest)
		return
	}

	err = runtime.BindQueryParameter("form", true, true, "architecture", r.URL.Query(), &params.Architecture)
	if err != nil {
		http.Error(w, fmt.Sprintf("Invalid format for parameter architecture: %s", err), http.StatusBadRequest)
		return
	}
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/architectures/{distribution}", wrapper.GetArchitectures)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/compose", wrapper.ComposeImage)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/composes", wrapper.GetComposes)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/composes/{composeId}", wrapper.GetComposeStatus)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/composes/{composeId}/metadata", wrapper.GetComposeMetadata)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/distributions", wrapper.GetDistributions)
	})
	r.Group(func(r chi.Router) {
