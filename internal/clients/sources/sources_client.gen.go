...
const (
	AccessKeySecretKey           BulkCreatePayloadAuthenticationsAuthtype = "access_key_secret_key"
	ApiTokenAccountId            BulkCreatePayloadAuthenticationsAuthtype = "api_token_account_id"
	Arn                          BulkCreatePayloadAuthenticationsAuthtype = "arn"
	BitbucketAppPassword         BulkCreatePayloadAuthenticationsAuthtype = "bitbucket-app-password"
	CloudMeterArn                BulkCreatePayloadAuthenticationsAuthtype = "cloud-meter-arn"
	DockerAccessToken            BulkCreatePayloadAuthenticationsAuthtype = "docker-access-token"
	GithubPersonalAccessToken    BulkCreatePayloadAuthenticationsAuthtype = "github-personal-access-token"
	GitlabPersonalAccessToken    BulkCreatePayloadAuthenticationsAuthtype = "gitlab-personal-access-token"
	LighthouseSubscriptionId     BulkCreatePayloadAuthenticationsAuthtype = "lighthouse_subscription_id"
	MarketplaceToken             BulkCreatePayloadAuthenticationsAuthtype = "marketplace-token"
	Ocid                         BulkCreatePayloadAuthenticationsAuthtype = "ocid"
	ProjectIdServiceAccountJson  BulkCreatePayloadAuthenticationsAuthtype = "project_id_service_account_json"
	QuayEncryptedPassword        BulkCreatePayloadAuthenticationsAuthtype = "quay-encrypted-password"
	ReceptorNode                 BulkCreatePayloadAuthenticationsAuthtype = "receptor_node"
	TenantIdClientIdClientSecret BulkCreatePayloadAuthenticationsAuthtype = "tenant_id_client_id_client_secret"
	Token                        BulkCreatePayloadAuthenticationsAuthtype = "token"
	UsernamePassword             BulkCreatePayloadAuthenticationsAuthtype = "username_password"
)
...
const (
	...
	OracleCloudInfraestructure BulkCreatePayloadSourcesSourceTypeName = "oracle-cloud-infraestructure"
...
const (
	EndpointAvailabilityStatus            EndpointAvailabilityStatus = ""
...
// Defines values for EndpointCreateAvailabilityStatus.
const (
	EndpointCreateAvailabilityStatus            EndpointCreateAvailabilityStatus = ""
	EndpointCreateAvailabilityStatusAvailable   EndpointCreateAvailabilityStatus = "available"
	EndpointCreateAvailabilityStatusUnavailable EndpointCreateAvailabilityStatus = "unavailable"
)

// Defines values for EndpointEditAvailabilityStatus.
const (
	EndpointEditAvailabilityStatus            EndpointEditAvailabilityStatus = ""
	EndpointEditAvailabilityStatusAvailable   EndpointEditAvailabilityStatus = "available"
	EndpointEditAvailabilityStatusUnavailable EndpointEditAvailabilityStatus = "unavailable"
)

// Defines values for EndpointReadAvailabilityStatus.
const (
	EndpointReadAvailabilityStatus            EndpointReadAvailabilityStatus = ""
...
// Expected payload when creating an application authentication
...
// ApplicationAuthentication object
...
// Expected payload to create an application
...
// Expected payload to update an application
...
// Expected payload when editing an Authentication object
...
type EndpointCreate struct {
	// The availability status of the endpoint.
	AvailabilityStatus *EndpointCreateAvailabilityStatus `json:"availability_status,omitempty"`
...
// The availability status of the endpoint.
type EndpointCreateAvailabilityStatus string

// Expected payload when editing an endpoint
type EndpointEdit struct {
	// The availability status of the endpoint.
	AvailabilityStatus *EndpointEditAvailabilityStatus `json:"availability_status,omitempty"`
...
// The availability status of the endpoint.
type EndpointEditAvailabilityStatus string
...
// Error structure for the "Unauthorized" responses
...
// PostRhcConnectionJSONRequestBody defines body for PostRhcConnection for application/json ContentType.
type PostRhcConnectionJSONRequestBody = PostRhcConnectionJSONBody

// UpdateRhcConnectionJSONRequestBody defines body for UpdateRhcConnection for application/json ContentType.
...
type ClientInterface interface {
	...
	ListAllAppMetaData(ctx context.Context, params *ListAllAppMetaDataParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ShowAppMetaData request
	ShowAppMetaData(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	ListApplicationAuthenticationsAuthentications(ctx context.Context, id ID, params *ListApplicationAuthenticationsAuthenticationsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	GetRhcConnections(ctx context.Context, params *GetRhcConnectionsParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostRhcConnection request with any body
	PostRhcConnectionWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostRhcConnection(ctx context.Context, body PostRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteRhcConnection request
	DeleteRhcConnection(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetRhcConnection request
	GetRhcConnection(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// UpdateRhcConnection request with any body
	UpdateRhcConnectionWithBody(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateRhcConnection(ctx context.Context, id ID, body UpdateRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetRhcConnectionSources request
	GetRhcConnectionSources(ctx context.Context, id ID, params *GetRhcConnectionSourcesParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ListAllAppMetaData(ctx context.Context, params *ListAllAppMetaDataParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) ShowAppMetaData(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) ListApplicationAuthenticationsAuthentications(ctx context.Context, id ID, params *ListApplicationAuthenticationsAuthenticationsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetRhcConnections(ctx context.Context, params *GetRhcConnectionsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostRhcConnectionWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostRhcConnection(ctx context.Context, body PostRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) DeleteRhcConnection(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetRhcConnection(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) UpdateRhcConnectionWithBody(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) UpdateRhcConnection(ctx context.Context, id ID, body UpdateRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetRhcConnectionSources(ctx context.Context, id ID, params *GetRhcConnectionSourcesParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewListAllAppMetaDataRequest(server string, params *ListAllAppMetaDataParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/app_meta_data")
	if operationPath[0] == '/' {
...
func NewShowAppMetaDataRequest(server string, id ID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/app_meta_data/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewListAllApplicationAuthenticationsRequest(server string, params *ListAllApplicationAuthenticationsParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/application_authentications")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteApplicationAuthenticationRequest(server string, id ID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/application_authentications/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewListApplicationAuthenticationsAuthenticationsRequest(server string, id ID, params *ListApplicationAuthenticationsAuthenticationsParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/applications_authentications/%s/authentications", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewListAuthenticationsRequest(server string, params *ListAuthenticationsParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/authentications")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteAuthenticationRequest(server string, id ID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/authentications/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewListEndpointAuthenticationsRequest(server string, id ID, params *ListEndpointAuthenticationsParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/endpoints/%s/authentications", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetRhcConnectionsRequest(server string, params *GetRhcConnectionsParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/rhc_connections")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewDeleteRhcConnectionRequest(server string, id ID) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/rhc_connections/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetRhcConnectionSourcesRequest(server string, id ID, params *GetRhcConnectionSourcesParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/rhc_connections/%s/sources", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	// ListAllAppMetaData request
	ListAllAppMetaDataWithResponse(ctx context.Context, params *ListAllAppMetaDataParams, reqEditors ...RequestEditorFn) (*ListAllAppMetaDataResponse, error)

	// ShowAppMetaData request
	ShowAppMetaDataWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowAppMetaDataResponse, error)

	// ListAllApplicationAuthentications request
	ListAllApplicationAuthenticationsWithResponse(ctx context.Context, params *ListAllApplicationAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListAllApplicationAuthenticationsResponse, error)

	// CreateApplicationAuthentication request with any body
	CreateApplicationAuthenticationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateApplicationAuthenticationResponse, error)

	CreateApplicationAuthenticationWithResponse(ctx context.Context, body CreateApplicationAuthenticationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateApplicationAuthenticationResponse, error)

	// DeleteApplicationAuthentication request
	DeleteApplicationAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteApplicationAuthenticationResponse, error)

	// ShowApplicationAuthentication request
	ShowApplicationAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowApplicationAuthenticationResponse, error)
	...
	// ListApplicationAuthenticationsAuthentications request
	ListApplicationAuthenticationsAuthenticationsWithResponse(ctx context.Context, id ID, params *ListApplicationAuthenticationsAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListApplicationAuthenticationsAuthenticationsResponse, error)

	// ListAuthentications request
	ListAuthenticationsWithResponse(ctx context.Context, params *ListAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListAuthenticationsResponse, error)

	// CreateAuthentication request with any body
	CreateAuthenticationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateAuthenticationResponse, error)

	CreateAuthenticationWithResponse(ctx context.Context, body CreateAuthenticationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateAuthenticationResponse, error)

	// DeleteAuthentication request
	DeleteAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteAuthenticationResponse, error)

	// ShowAuthentication request
	ShowAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowAuthenticationResponse, error)

	// UpdateAuthentication request with any body
	UpdateAuthenticationWithBodyWithResponse(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateAuthenticationResponse, error)

	UpdateAuthenticationWithResponse(ctx context.Context, id ID, body UpdateAuthenticationJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateAuthenticationResponse, error)
	...
	// DeleteEndpoint request
	DeleteEndpointWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteEndpointResponse, error)

	// ShowEndpoint request
	ShowEndpointWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowEndpointResponse, error)

	// UpdateEndpoint request with any body
	UpdateEndpointWithBodyWithResponse(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateEndpointResponse, error)

	UpdateEndpointWithResponse(ctx context.Context, id ID, body UpdateEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateEndpointResponse, error)

	// ListEndpointAuthentications request
	ListEndpointAuthenticationsWithResponse(ctx context.Context, id ID, params *ListEndpointAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListEndpointAuthenticationsResponse, error)
	...
	// GetDocumentation request
	GetDocumentationWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetDocumentationResponse, error)

	// GetRhcConnections request
	GetRhcConnectionsWithResponse(ctx context.Context, params *GetRhcConnectionsParams, reqEditors ...RequestEditorFn) (*GetRhcConnectionsResponse, error)

	// PostRhcConnection request with any body
	PostRhcConnectionWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostRhcConnectionResponse, error)

	PostRhcConnectionWithResponse(ctx context.Context, body PostRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*PostRhcConnectionResponse, error)

	// DeleteRhcConnection request
	DeleteRhcConnectionWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteRhcConnectionResponse, error)

	// GetRhcConnection request
	GetRhcConnectionWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*GetRhcConnectionResponse, error)

	// UpdateRhcConnection request with any body
	UpdateRhcConnectionWithBodyWithResponse(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateRhcConnectionResponse, error)

	UpdateRhcConnectionWithResponse(ctx context.Context, id ID, body UpdateRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateRhcConnectionResponse, error)

	// GetRhcConnectionSources request
	GetRhcConnectionSourcesWithResponse(ctx context.Context, id ID, params *GetRhcConnectionSourcesParams, reqEditors ...RequestEditorFn) (*GetRhcConnectionSourcesResponse, error)
...
func (c *ClientWithResponses) ListAllAppMetaDataWithResponse(ctx context.Context, params *ListAllAppMetaDataParams, reqEditors ...RequestEditorFn) (*ListAllAppMetaDataResponse, error) {
	rsp, err := c.ListAllAppMetaData(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ShowAppMetaDataWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowAppMetaDataResponse, error) {
	rsp, err := c.ShowAppMetaData(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ListAllApplicationAuthenticationsWithResponse(ctx context.Context, params *ListAllApplicationAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListAllApplicationAuthenticationsResponse, error) {
	rsp, err := c.ListAllApplicationAuthentications(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateApplicationAuthenticationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateApplicationAuthenticationResponse, error) {
	rsp, err := c.CreateApplicationAuthenticationWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateApplicationAuthenticationWithResponse(ctx context.Context, body CreateApplicationAuthenticationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateApplicationAuthenticationResponse, error) {
	rsp, err := c.CreateApplicationAuthentication(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateApplicationAuthenticationResponse(rsp)
...
func (c *ClientWithResponses) DeleteApplicationAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteApplicationAuthenticationResponse, error) {
	rsp, err := c.DeleteApplicationAuthentication(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ShowApplicationAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowApplicationAuthenticationResponse, error) {
	rsp, err := c.ShowApplicationAuthentication(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ListApplicationAuthenticationsAuthenticationsWithResponse(ctx context.Context, id ID, params *ListApplicationAuthenticationsAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListApplicationAuthenticationsAuthenticationsResponse, error) {
	rsp, err := c.ListApplicationAuthenticationsAuthentications(ctx, id, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ListAuthenticationsWithResponse(ctx context.Context, params *ListAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListAuthenticationsResponse, error) {
	rsp, err := c.ListAuthentications(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateAuthenticationWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateAuthenticationResponse, error) {
	rsp, err := c.CreateAuthenticationWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateAuthenticationWithResponse(ctx context.Context, body CreateAuthenticationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateAuthenticationResponse, error) {
	rsp, err := c.CreateAuthentication(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateAuthenticationResponse(rsp)
...
func (c *ClientWithResponses) DeleteAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteAuthenticationResponse, error) {
	rsp, err := c.DeleteAuthentication(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ShowAuthenticationWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowAuthenticationResponse, error) {
	rsp, err := c.ShowAuthentication(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateAuthenticationWithBodyWithResponse(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateAuthenticationResponse, error) {
	rsp, err := c.UpdateAuthenticationWithBody(ctx, id, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateAuthenticationWithResponse(ctx context.Context, id ID, body UpdateAuthenticationJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateAuthenticationResponse, error) {
	rsp, err := c.UpdateAuthentication(ctx, id, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateAuthenticationResponse(rsp)
...
func (c *ClientWithResponses) DeleteEndpointWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteEndpointResponse, error) {
...
func (c *ClientWithResponses) ShowEndpointWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*ShowEndpointResponse, error) {
...
func (c *ClientWithResponses) UpdateEndpointWithBodyWithResponse(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateEndpointResponse, error) {
...
func (c *ClientWithResponses) UpdateEndpointWithResponse(ctx context.Context, id ID, body UpdateEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateEndpointResponse, error) {
...
func (c *ClientWithResponses) ListEndpointAuthenticationsWithResponse(ctx context.Context, id ID, params *ListEndpointAuthenticationsParams, reqEditors ...RequestEditorFn) (*ListEndpointAuthenticationsResponse, error) {
	rsp, err := c.ListEndpointAuthentications(ctx, id, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetDocumentationWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetDocumentationResponse, error) {
	rsp, err := c.GetDocumentation(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetRhcConnectionsWithResponse(ctx context.Context, params *GetRhcConnectionsParams, reqEditors ...RequestEditorFn) (*GetRhcConnectionsResponse, error) {
	rsp, err := c.GetRhcConnections(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) PostRhcConnectionWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostRhcConnectionResponse, error) {
	rsp, err := c.PostRhcConnectionWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) PostRhcConnectionWithResponse(ctx context.Context, body PostRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*PostRhcConnectionResponse, error) {
	rsp, err := c.PostRhcConnection(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostRhcConnectionResponse(rsp)
...
func (c *ClientWithResponses) DeleteRhcConnectionWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*DeleteRhcConnectionResponse, error) {
	rsp, err := c.DeleteRhcConnection(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetRhcConnectionWithResponse(ctx context.Context, id ID, reqEditors ...RequestEditorFn) (*GetRhcConnectionResponse, error) {
	rsp, err := c.GetRhcConnection(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateRhcConnectionWithBodyWithResponse(ctx context.Context, id ID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateRhcConnectionResponse, error) {
	rsp, err := c.UpdateRhcConnectionWithBody(ctx, id, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateRhcConnectionWithResponse(ctx context.Context, id ID, body UpdateRhcConnectionJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateRhcConnectionResponse, error) {
	rsp, err := c.UpdateRhcConnection(ctx, id, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateRhcConnectionResponse(rsp)
...
func (c *ClientWithResponses) GetRhcConnectionSourcesWithResponse(ctx context.Context, id ID, params *GetRhcConnectionSourcesParams, reqEditors ...RequestEditorFn) (*GetRhcConnectionSourcesResponse, error) {
	rsp, err := c.GetRhcConnectionSources(ctx, id, params, reqEditors...)
	if err != nil {
		return nil, err
	}
