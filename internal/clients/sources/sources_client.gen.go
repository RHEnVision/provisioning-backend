// Package SourcesApi provides primitives to interact with the openapi HTTP API.
//
...
const (
	...
	EndpointCreateAvailabilityStatusEmpty EndpointCreateAvailabilityStatus = ""
...
const (
	...
	EndpointEditAvailabilityStatusEmpty EndpointEditAvailabilityStatus = ""
...
type BulkCreatePayloadResponse struct {
...
type BulkCreateResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *BulkCreatePayloadResponse
	JSON400      *ErrorBadRequest
}
...
func ParseBulkCreateResponse(rsp *http.Response) (*BulkCreateResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 201:
		var dest BulkCreatePayloadResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON201 = &dest
