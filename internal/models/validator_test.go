...
func TestPubkeyMissingName(t *testing.T) {
	...
	pk.Name = ""
	err := models.Validate(context.Background(), pk)
	require.EqualError(t, err, "Key: 'Pubkey.Name' Error:Field validation for 'Name' failed on the 'required' tag")
}
...
func TestPubkeyMissingBody(t *testing.T) {
	...
	pk.Body = ""
	err := models.Validate(context.Background(), pk)
	require.EqualError(t, err, "Key: 'Pubkey.Body' Error:Field validation for 'Body' failed on the 'required' tag")
}
...
func TestPubkeyInvalidBody(t *testing.T) {
	...
	pk.Body = "xxx"
	err := models.Validate(context.Background(), pk)
	require.EqualError(t, err, "Key: 'Pubkey.Body' Error:Field validation for 'Body' failed on the 'sshPubkey' tag")
}
...
func TestBodyWithUsername(t *testing.T) {
	...
	t.Run("empty RSA", func(t *testing.T) {
		...
		pkBody, err := pk.BodyWithUsername(context.Background())
		require.EqualError(t, err, "invalid public key format")
